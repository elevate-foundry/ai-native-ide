/**
 * Aria LLM Integration via OpenRouter
 * 
 ...
 */
export async function ariaAnalyze(sensorSnapshot, goal, client = null) {
...
export async function ariaGeneratePlan(goal, context = {}, client = null) {
  const llm = client || createLLMClient();
...
export { ARIA_SYSTEM_PROMPT, DEFAULT_CONFIG };
